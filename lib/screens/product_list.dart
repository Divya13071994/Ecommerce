...
import 'package:flutter_application_ecart/database/db_helper.dart';
import 'package:flutter_application_ecart/model/cart_model.dart';
import 'package:flutter_application_ecart/model/item_model.dart';
import 'package:flutter_application_ecart/provider/cart_provider.dart';
import 'package:flutter_application_ecart/screens/cart_screen.dart';
  ...
  Widget build(BuildContext context) {
    ...
    void saveData(int index) {
      dbHelper
        ...
        cart.addCounter();
         var snackBar = SnackBar(content: Text("${products[index].name} added to cart"));
